...
let htmlBulidrevFn = function (cb) {
      gulp.src(['rev/**/*.json', `${targetPath}html/**/*.html`])
            .pipe(revCollector({
                  replaceReved: true,
                  dirReplacements: {
                        'css': '/css',
